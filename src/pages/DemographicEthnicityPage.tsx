...
const DemographicEthnicityPage = () => {
  ...
  const handleBack = () => {
    navigate('/property-details'); // Or the appropriate back page
  };
      ...
      <div className="flex flex-col items-center justify-center flex-grow w-full max-w-3xl mx-auto py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-3xl mb-12">
          <SelectionCard
            ...
            selected={selectedOption === 'hispanic'}
            onClick={() => handleOptionSelect('hispanic')}
          />
          <SelectionCard
            title="Not Hispanic or Latino"
            selected={selectedOption === 'not-hispanic'}
            onClick={() => handleOptionSelect('not-hispanic')}
          />
          <SelectionCard
...
export default DemographicEthnicityPage;
