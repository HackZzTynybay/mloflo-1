    ...
    if (field === 'phone') {
      if (value === '' || /^[\d()\-\s+]*$/.test(value)) {
        ...
        if (digitsOnly.length <= 3) {
          formattedPhone = digitsOnly.length ? `(${digitsOnly}` : '';
        ...
        <form onSubmit={handleSubmit} className="w-full space-y-6">
          <div>
            <Label htmlFor="employerName" className="flex items-center">
              Employer or Business Name <span className="text-red-500 ml-1">*</span>
            </Label>
            <Input
              id="employerName"
          ...
          <div>
            ...
            <div className="relative">
              <Input
                ...
                className={`mt-1 pr-10 ${errors.address ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
              />
          ...
          <div>
            <Label htmlFor="income" className="flex items-center">
              Gross Monthly Income before Deductions <span className="text-red-500 ml-1">*</span>
            </Label>
