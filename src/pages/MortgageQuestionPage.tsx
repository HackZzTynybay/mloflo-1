    ...
    >
      <div className="flex flex-col items-center justify-center flex-grow w-full max-w-3xl mx-auto py-8">
        <h1 className="text-2xl font-bold mb-10 text-center">
          Do you have a mortgage associated with this property?
        </h1>
        ...
        <div className="flex justify-center mt-auto">
          <Button 
            ...
            onClick={() => navigate('/property-relationship')}
          >
            Back
          </Button>
...
export default MortgageQuestionPage;
