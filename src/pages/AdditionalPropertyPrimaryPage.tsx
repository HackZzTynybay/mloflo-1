...
const AdditionalPropertyPrimaryPage = () => {
  ...
  const handleNext = () => {
    if (selectedOption === 'yes') {
      navigate('/additional-property-subject');
    } else {
    ...
    >
      <div className="flex flex-col items-center justify-center flex-grow w-full max-w-3xl mx-auto py-8">
        <h1 className="text-2xl font-bold mb-10 text-center">
          Do you own additional real estate properties other than your primary?
        </h1>
        ...
        <div className="flex justify-center mt-auto">
          <Button 
            ...
            onClick={() => navigate('/additional-real-estate-properties')}
          >
            Back
          </Button>
...
export default AdditionalPropertyPrimaryPage;
