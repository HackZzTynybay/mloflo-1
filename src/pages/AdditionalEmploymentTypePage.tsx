...
const AdditionalEmploymentTypePage = () => {
  ...
  const handleNext = () => {
    if (selectedOption === 'employed') {
      ...
      navigate('/additional-self-employment-details');
    }
  };
    ...
    >
      <div className="flex flex-col items-center justify-center flex-grow w-full max-w-3xl mx-auto py-8">
        <h1 className="text-2xl font-bold mb-10 text-center">
          What is your additional employment details?
        </h1>
...
export default AdditionalEmploymentTypePage;
